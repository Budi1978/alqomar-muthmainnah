...
- **Di DB dipecah jadi 23 halaqah** bernama Sahabat (permintaan user, nama lama hilang): format "<Nama Sahabat> — Kelas X", pembimbing_nama pakai gelar Ust./Usth. Daftar: IA Abu Bakar Ash-Shiddiq (Een 15) & Umar bin Khattab (Rahayu Vina 15) · IB Utsman bin Affan (Ulfa 15) & Ali bin Abi Thalib (Anindita 14) · IIA Thalhah (Kustiah 16) & Zubair (Mita 16) · IIB Abdurrahman bin Auf (Nurnaningsih 16) & Sa'ad bin Abi Waqqash (Widiya 15) · IIIA Sa'id bin Zaid (Sjarniwati 15) & Abu Ubaidah (Yushal 14) · IIIB Bilal (Syafsila 15) & Mush'ab (Salamatul Laila 14) · IVA Khalid bin Walid (Ninik 14) & Hamzah (Ropiyati 13) · IVB Salman Al-Farisi (Andi Ilham 14) & Abu Dzar (Aranda 13) · VA Abdullah bin Mas'ud (Ellida 10) & Mu'adz bin Jabal (Annisa 9) · VB Zaid bin Tsabit (Selvi 15) & Ubay bin Ka'ab (Rifa 5) · VI Ammar bin Yasir (Rifa 6), Abu Hurairah (Fatmarianti 17), Anas bin Malik (Iman 14). Tiap sub-halaqah `pembimbing_id` = guru itu; guru hanya melihat sub-halaqahnya. Batas kurung dibaca dari posisi label di PDF SK (heuristik), kalau ada yang meleset koordinator geser santri di Kelola Halaqah.
- Akun pendamping dibuat Aira 19 Sep 2026: **Widiya `widiya@alqomar.id`** (baris guru baru dibuat) dan **Aranda `aranda.firdaus@alqomar.id`**; password awal diserahkan ke user. Keduanya kini pembimbing halaqahnya sendiri. **Annisa Annahl R (VA) sengaja belum dibuatkan akun** (keputusan user), halaqahnya masih di-cover Ellida lewat `pendamping_id`.
