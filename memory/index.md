...
- [[catatan/design-system-artifact]] — **TODO (19 Sep 2026)**: (1) upload `event.html` hasil migrasi ke Hostinger, (2) merge branch `claude/design-system-extraction-5zuukp` ke `main`, (3) migrasi sisa halaman legacy `berita.html`, `berita-detail.html`, `ppdb.html`, `berita/index.html`, (4) belum ada skill yang diperbarui dengan sistem desain — tentukan skill tujuan bila diperlukan
